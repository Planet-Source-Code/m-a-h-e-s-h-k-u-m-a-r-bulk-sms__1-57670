VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} rpMessages 
   Caption         =   "Report"
   ClientHeight    =   8595
   ClientLeft      =   60
   ClientTop       =   345
   ...
   BeginProperty Section0 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item0 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         EndProperty
         ForeColor       =   4210752
         Object.Caption         =   "Messages Report"
      EndProperty
      ItemType1       =   3
...
'Sections.Item("headers").Controls


Private Sub DataReport_Initialize()
On Error Resume Next
    Set rpMessages.DataSource = rs.DataSource
    
    With rpMessages

    With .Sections("datasection").Controls
